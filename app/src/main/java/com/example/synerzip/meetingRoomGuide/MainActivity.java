...
//        Spinner spinner = (Spinner) findViewById(R.id.spinner);
        ...
        for(int i = 0; i < table.getChildCount() && length != 0; i++) {
            View row = table.getChildAt(i);
            if (row instanceof TableRow) {
                // then, you can remove the the row you want...
                // for instance...
                TableRow tableRow = (TableRow) row;
                for(int j = 0; j < tableRow.getChildCount() && length != 0; j++) {
                    ...
                    String roomName = calendarNames.get(count);
...
//                    Button button = (Button) findViewById(R.id.room1);
                    ...
                    //					t.removeView(row);
                    //				}
                    // Button button1 = (Button) findViewById(R.id.room1);
                }
            }
        }
...
//        calendarEventList = getDataForListView(MainActivity.this, meetingRoomNames.get(calendarNames.get(1)).toString());
//        checkOngoingMeeting(calendarEventList);
//        calendarListAdapter = new CalendarListAdapter();
//        setListAdapter(calendarListAdapter);
    }


//    public String getShortMeetingRoomName(String meetingRoomName) {
//
////        int indexEnd = meetingRoomName.toLowerCase().indexOf("-", 2);
////        if(indexEnd == -1)
////        {
////            return meetingRoomName;
////        }
////        String sm = meetingRoomName.toLowerCase().substring(0, indexEnd);
////        return sm;
//
